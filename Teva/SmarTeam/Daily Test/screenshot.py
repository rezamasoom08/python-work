...
# Function to handle the GUI submission
def on_submit():
...
# Open the web page
    urls = ['https://ilstweb-st.teva.corp/WebEditor/Authentication/LoginPage.aspx?ReturnUrl=%2fwebeditor']  # replace with the desired URL
...
tk.Button(root, text='Web & View', fg='Black', bg='grey', width = 20,
                font=('Ubuntu Mono', 10), command=on_submit).grid(row=4, column=0, columnspan=2, pady=12, sticky='n')

tk.Button(root, text='Dummy User', fg='Black',  width = 20, command=dummy,
                            bg='grey', font=('Ubuntu Mono', 10)).grid(row=5, column=0, columnspan=2, pady=12, sticky='n')

tk.Button(root, text='Query Portal', fg='Black', command = portal, width = 20,
                            bg='grey', font=('Ubuntu Mono', 10)).grid(row=6, column=0, columnspan=2, pady=10, sticky='n')
